		...
		for (var i = 0, o; o = this.div[i]; i++)
		{
			if (o.className == 'frame')
			{
				...
				o.r.resize = function ()
				{
					...
					this.img.style.width  = (i.width  < this.offsetWidth) ? Math.round(this.offsetWidth  * 1) + 'px' : Math.round(i.width) + 'px';
					this.img.style.height = (i.height < this.offsetHeight) ? Math.round(this.offsetHeight * 1) + 'px' : Math.round(i.height) + 'px';
